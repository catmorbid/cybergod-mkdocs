...
- **Extreme** distance is very far away and needs more than one action to catch up to. Extreme Distance can be further divided several brackets if needed, e.g. Extreme-1, Extreme-2, Extreme-3 etc. *In the horizon*
