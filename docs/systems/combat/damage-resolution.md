...
3. *GM Checks if Damage Roll is needed, based on final Damage Class and number of Hits*
4. Roll and sum Damage Dice from number of hits and final modified [[#Damage Class]]
5. Compare total rolled Damage to [[stats#Damage Threshold|Damage Thresholds]] and mark the resulting [[systems/combat/damage/index|Damage Condition]]
