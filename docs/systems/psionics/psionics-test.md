...
[[augment-effect-active|Active Psionic Augment Effects]] can utilize the [[psionics-potency|Potency]] Effect that allows you to scale the effect’s properties. You can also [[psionics-combinations|combine]] different effects in one test and take the [[psionics-concentration|Concentrate]] action to get additional [[augment-effect-advantage|Advantage Dice]].