...
Hacks are single-use self-contained cyberwarfare package with isolated AI optimizing the deployment vectors to maximum efficiency. Once deployed, the hack runs independently until it has completed its goals. As the hack is detected by target system, all connected networks receive security alerts with the package’s identity hash that can be used to identify the exact package if a clone were to be deployed again. Subsequent attacks are almost completely inefficient if the security alerts manage to go through.
...
- **Activation:** Spend 1 Energy and test `Hacking (Cyber)` to activate in an Instant once per Turn.

## Level 1
#### Passive Effects
 - **Cyber Warfare Apps** • **Hack Slots:** 2 Basic<br>You have Basic, Advanced and Ultra Hack Slots for deploying hacks of corresponding level. Deploying a hack uses a slot.
 - **Firewall** • **Cyber Defense Bonus:** 1<br>Improved Cyber Defense when cyberjacked.

#### Active Effects
- **Basic Hack** • **EP:** 1 • **Stack:** 1<br>Deploy an **Basic Hack** to **Target** in **Cyberweb** range. You cannot deploy the same hack twice.
- **Advanced Hack** • **EP:** 2 • **Stack:** 1<br>Deploy an **Advanced Hack** to **Target** in **Cyberweb** range. You cannot deploy the same hack twice.

## Level 2
#### Passive Effects
 - **Cyber Warfare Apps** • **Hack Slots:** 4 Basic, 2 Advanced<br>You have Basic, Advanced and Ultra Hack Slots for deploying hacks of corresponding level. Deploying a hack uses a slot.
 - **Firewall** • **Cyber Defense Bonus:** 2<br>Improved Cyber Defense when cyberjacked.

#### Active Effects
- **Ultra Hack** • **EP:** 3 • **Stack:** 1<br>Deploy an **Ultra Hack** to **Target** in **Cyberweb** range. You cannot deploy the same hack twice.
- **Stealth Hack** • **EP:** 2 • **Stack:** 3<br>Increase difficulty of Trace test by 1 for **Short** duration.

## Level 3
#### Passive Effects
 - **Cyber Warfare Apps** • **Hack Slots:** 8 Basic, 4 Advanced, 2 Ultra<br>You have Basic, Advanced and Ultra Hack Slots for deploying hacks of corresponding level. Deploying a hack uses a slot.
 - **Firewall** • **Cyber Defense Bonus:** 3<br>Improved Cyber Defense when cyberjacked.

#### Active Effects
- **Cascade** • **EP:** 1 • **Stack:** 1<br>One effect cascades affecting another target.
