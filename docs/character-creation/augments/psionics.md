...
- **Safety Checks:** Many of the listed effects result in [[character-creation/persona/index#Safety Check|Safety Checks]] representing gradual [[character-creation/persona/index#Corruption|Corruption]] and high level effects may directly add *Corruption*.
