...
Sidearms are small **(Bulk 1)** and easily concealed under clothing. They are not suitable for main weapons in serious combat duty, but serve as easily concealable backup weapons. Sidearms can be used effectively one-handed, but a two-handed grip is more common, reducing their effective [[#Recoil]] by one.
...
**Launchers and Cannons**: `Ranged Combat x Mind`
...
| Explosive Type               | Typical Use               | DC  | Notes                                                                  |
| ---------------------------- | ------------------------- | --- | ---------------------------------------------------------------------- |
| **Frag Hand Grenade**        | Thrown anti-personnel     | 12  | Single hit = primary blast; multiple hits (shrapnel) add DC 3–5 each.  |
| **Stun/Flashbang**           | Non-lethal disorientation | 4   | Low DC; causes Shock only, but wide area effect.                       |
| **Frag Grenade Launcher**    | Underslung/stand-alone    | 14  | More energetic warhead; produces 2–3 shrapnel hits per target.         |
| **Rocket-Propelled Grenade** | Anti-armor/anti-structure | 16  | DC16 blast + DC8 concentrated shaped-charge; excels vs cover.          |
| **Pipe Bomb/IED**            | Improvised high-yield     | 15  | Variable yield; average around DC15 with 2–4 fragment hits.            |
| **Satchel Charge**           | Breaching/demolitions     | 18  | Large blast radius, heavy fragmentation; multiple DC8–12 hits.         |
| **C4 Demolition Charge**     | Military breaching        | 20  | Massive overpressure; DC20 single-hit, plus DC10 frag repeats.         |
| **Rocket Launcher (HE)**     | Light vehicle/structure   | 18  | Shaped-charge plus blast; often two hits: DC14 + DC10 frag.            |
| **Anti-Tank Mine**           | Vehicle ambush            | 20  | DC20 under-hull blast; DC12 secondary fragment hits.                   |
| **Thermobaric Charge**       | Enclosed-space clearing   | 22  | Sustained blast; DC22 overpressure + DC8 fragmentation.                |
| **Tactical Nuke (mini)**     | Strategic/area denial     | 30  | Catastrophic: DC30 single blast, followed by multiple DC20 shockwaves. |
