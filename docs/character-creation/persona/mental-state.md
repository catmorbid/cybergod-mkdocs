...
!!! example "Kitah"
	Kitah is a seasoned Professional, so they must increase their Mental State by total 3 points, starting at D4. Kitah chooses: Dissociation +2 (D8), Habituation + 1 (D6). Kitah is a survivor and has issues connecting socially, but they are not a accustomed to extreme violence.
### Dissociation
...
!!! info "Dissociation and social tests"
	When engaging in social dialogue, your base difficulty is set by your level of Dissociation. Add Difficult 1 complication for every level of Dissociation after D4.
...
| ----- | -------------------- | --------------------------------------------------------------------------------------------- |
| D4    | Sensitive            | You react strongly to new stimuli including violence and distress.                            |
| D6    | Mild Habituation     | Gradual reduction in sensitivity to repeated stimuli, less reactive to familiar stressors     |
| D8    | Moderate Habituation | Significantly reduced emotional response to stimuli that once caused distress.                |
| D10   | Severe Habituation   | Major indifference to violence and suffering, nearly inhuman emotional response.              |
